...
// FIELD LINK LOOKUPS AND FIELD LINK FIELDS
		...
		public WebElement Field_Link_Lookup_CoffeeCount;
				...
				@TextType()
				@FindBy(xpath = "//ul[contains(@class, \"list-group\")]/li[1]/div[5]")
				public WebElement _2_Multi_Select_Pick_List_Edit_Button;
				...
				@TextType()
				@FindBy(xpath = "//li[2]//div[5]")
				public WebElement __e_mail_edit_button;

				@TextType()
				@FindBy(xpath = "//li[3]//div[5]")
				public WebElement _1_number_edit_button;

				@TextType()
				@FindBy(xpath = "//li[4]//div[5]")
				public WebElement __Date__Time_Edit_Button;

				@TextType()
				@FindBy(xpath = "//li[5]//div[5]")
				public WebElement _2_Multi_Select_Pick_List_Edit_Button1;

				@TextType()
				@FindBy(xpath = "//li[6]//div[5]")
				public WebElement _0_Long_Text_Edit_Button;

				@TextType()
				@FindBy(xpath = "//li[7]//div[5]")
				public WebElement _5_Radio_Button_List_Edit_Button;

				@TextType()
				@FindBy(xpath = "//li[8]//div[5]")
				public WebElement _7_Yes_No_Edit_Button;

				@TextType()
				@FindBy(xpath = "//li[9]//div[5]")
				public WebElement _6_Url_Edit_Button;

				@TextType()
				@FindBy(xpath = "//li[10]//div[5]")
				public WebElement _4_Phone_Edit_Button;

				@TextType()
				@FindBy(xpath = "//li[11]//div[5]")
				public WebElement __E_Signature_Edit_Button;

				@LinkType()
				@FindBy(linkText = "\n\t\t\t\t\t\tDISPLAY LOGIC\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t  \n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t")
				public WebElement Display_Logic;

				@LinkType()
				@FindBy(css = "#tab-scoped-2__item")
				public WebElement Display_Logic_Edit_Tab;

				@ChoiceListType(values = { @ChoiceListValue(value = "string:3d730a2b", title = "A") })
				@FindBy(xpath = "//td[2]/span/div/div/select")
				public WebElement Display_Logic_Section_Edit_Field;

				@ChoiceListType(values = { @ChoiceListValue(value = "string:152258e6", title = "15-Radio Button List"),
						@ChoiceListValue(value = "string:c7c50d3", title = "6-Picklist") })
				@FindBy(xpath = "//td[3]/span/div/div/select")
				public WebElement Display_Logic_Question_Edit_Field;

				@BooleanType()
				@FindBy(xpath = "//input[@name=\"depValues0-Yes\"]")
				public WebElement Display_Logic_Following_Values_Edit;

				@TextType()
				@FindBy(xpath = "//ul[contains(@class, \"list-group\")]/li[1]/div[5]")
				public WebElement _12_Multi_Select_Pick_List_Edit_Button;

				@ChoiceListType(values = { @ChoiceListValue(value = "Always"),
						@ChoiceListValue(value = "Conditional Visibility") })
				@FindBy(xpath = "//*[@id=\"questionDependent\"]")
				public WebElement Display_Logic_Viewable_Edit_Button;

				@TextType()
				@FindBy(css = "li.list-group-item.OR-question-box.ng-scope.question-0.ui-sortable-handle.make-relative[data-question-name=\"10-Long-Text\"] div.qb-edit.flex-center.editQuestion.ng-scope")
				public WebElement _10_Long_Text_Edit_Button;

				@BooleanType()
				@FindBy(xpath = "//input[@name=\"depValues0-Protein\"]")
				public WebElement Display_Logic_Values_multiPL_Protein_;

				@TextType()
				@FindBy(css = "li.list-group-item.OR-question-box.ng-scope.question-0.ui-sortable-handle[data-question-name=\"6-Picklist\"] div.qb-edit.flex-center.editQuestion.ng-scope")
				public WebElement _6_Picklist_Edit_Button;

				@ButtonType()
				@FindBy(css = "button.slds-button.slds-button_brand.saveAndContinueBtn")
				public WebElement Template_Builder_Continue_Button;
